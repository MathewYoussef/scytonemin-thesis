...
| **Key findings** | Raw chromatogram metrics showed no significant main/interaction effects (p-values 0.099–0.297). Normalized chromatogram metrics produced clear interaction signals for delta (p ≈ 0.0085–0.013) and z-score endpoints (p ≈ 0.034–0.040, η² ≈ 0.33–0.43), whereas ratio/percent variants were only marginal (p ≈ 0.072–0.12). DAD interactions were borderline (p≈0.058, η²≈0.71). Continuous models had low R² (≤0.17) despite positive UVB coefficients for amount metrics. |
